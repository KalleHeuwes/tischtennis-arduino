...
# pfad_3 = calculate_trajectory('schlag_3.csv')
...
# Kurve 3 plotten
# ax.plot(pfad_3[:, 0], pfad_3[:, 1], pfad_3[:, 2], label='Schlag 3', color='green', lw=2)
# ax.scatter(pfad_3[0,0], pfad_3[0,1], pfad_3[0,2], color='green', s=50, marker='x') # Start 3
