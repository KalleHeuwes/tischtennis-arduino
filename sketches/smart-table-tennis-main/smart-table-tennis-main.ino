...
void readIMU(){
  ...
  r[0]=ax*CONVERT_G_TO_MS2; r[1]=ay*CONVERT_G_TO_MS2; r[2]=az*CONVERT_G_TO_MS2;
...
switch(inf.index){case 0:countBHdrive++;break;case 1:countBHsmash++;break;case 2:countFHdrive++;break;case 3:countFHloop++;break;case 4:countFHsmash++;break;}
